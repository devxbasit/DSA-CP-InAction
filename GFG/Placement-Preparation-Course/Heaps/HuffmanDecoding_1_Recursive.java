...
class GfG {
    ...
    String decodeRecur(minHeapNode root, minHeapNode node, String S, int n, int i, String res){
        ...
        if (node.left == null && node.right == null){
            ...
            // dont increament i
            return decodeRecur(root, root, S, n, i, res);
        }
        ...
        return S.charAt(i) == '0' ? decodeRecur(root, node.left, S, n, i + 1, res) :
                                        decodeRecur(root, node.right, S, n, i + 1, res);
    ...
    String decodeString(minHeapNode root, String encodedStr){
        ...
        return decodeRecur(root, root, encodedStr, encodedStr.length(), 0, "");
    }
}
