...
class Driver_class {
  ...
  public static void main(String args[]) throws IOException {
    ...
    while (t-- > 0) {
      ...
      for (int i = 0; i < str.length(); i++) encodedString +=
        codes.get(str.charAt(i));
      //cout<<encodedString<<endl;
      decodedString =
        new Decode().decodeHuffmanData(minHeap.peek(), encodedString);
  ...
  static PriorityQueue<MinHeapNode> minHeap = new PriorityQueue<MinHeapNode>(
    new MyComparator()
  );
