...
/*
    https://leetcode.com/problems/min-stack/discuss/1092624/using-stack-and-class-node
    
    hey @SmartCoder_06 I think this approach is space inefficient (better is to use two stacks approach)
    ...
    but if we solve this problem using two stacks approach [ https://www.youtube.com/watch?v=4bjCEJmiPZA ]
